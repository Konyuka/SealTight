...
<template>
    <div>
        ...
        <footer
            class="bg-black relative z-[1] before:absolute before:inset-0 before:-z-[1] before:bg-[url('https://img.freepik.com/free-vector/abstract-modern-dark-black-background-design-with-stripes-lines_84443-2803.jpg?t=st=1741779218~exp=1741782818~hmac=a56a273940d5e8d8a29965d2b859423e268c9ef0e6a5673728225a95ed13cc6b&w=2000')] before:opacity-[7%] before:bg-no-repeat before:bg-cover before:bg-center text-white">
            <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
                ...
                <div class="flex flex-wrap justify-between gap-[35px] pt-[100px] pb-[58px] border-b border-white/20">
                    ...
                    <div class="max-w-[370px] xxs:max-w-full">
                        <a href="index.html" class="inline-block mb-[23px]"><img src="/assets/img/Logo4.png"
                                alt="logo"></a>
                    ...
                    <div>
                        ...
                        <div class="space-y-[18px]">
                            <a href="#" class="flex items-center gap-[10px] opacity-80 hover:text-edyellow"><span
                                    class="icon"><img src="/assets/img/double-arrow.svg" alt="icon"></span>
                                About Us</a>
                            <a href="#" class="flex items-center gap-[10px] opacity-80 hover:text-edyellow"><span
                                    class="icon"><img src="/assets/img/double-arrow.svg" alt="icon"></span> Contact
                                Us</a>
                            <a href="#" class="flex items-center gap-[10px] opacity-80 hover:text-edyellow"><span
                                    class="icon"><img src="/assets/img/double-arrow.svg" alt="icon"></span> Blog &
                                News</a>
                            <a href="#" class="flex items-center gap-[10px] opacity-80 hover:text-edyellow"><span
                                    class="icon"><img src="/assets/img/double-arrow.svg" alt="icon"></span> FAQ’S</a>
                            <a href="#" class="flex items-center gap-[10px] opacity-80 hover:text-edyellow"><span
                                    class="icon"><img src="/assets/img/double-arrow.svg" alt="icon"></span> Login /
                                Register</a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-[18px]">
                            ...
                            <a href="#" class="flex items-center gap-[10px] opacity-80 hover:text-edyellow"><span
                                    class="icon"><img src="/assets/img/double-arrow.svg" alt="icon"></span> Book
                                Demo</a>
                            <a href="#" class="flex items-center gap-[10px] opacity-80 hover:text-edyellow"><span
                                    class="icon"><img src="/assets/img/double-arrow.svg" alt="icon"></span>
                                Meets Up's</a>
                    ...
                    <div class="max-w-[300px]">
                        ...
                        <div>
                            <p class="text-[#d9d9d9]/80 mb-[21px]">Sign up to seargin weekly newsletter to get the
                                latest updates.</p>
                            ...
                            <form class="border border-white/20 rounded-full flex h-[56px] p-[4px]">
                                ...
                                <button
                                    class="bg-edyellow rounded-3xl  py-2 px-3 aspect-square flex items-center justify-center hover:bg-edpurple"><img
                                        src="/assets/img/icon/submit-icon.svg" alt="icon"></button>
                            </form>
