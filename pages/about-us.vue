...
<template>
    <div>
        <main>
            ...
            <section
                class="pt-[327px] xl:pt-[287px] lg:pt-[237px] sm:pt-[200px] xxs:pt-[180px] pb-[158px] xl:pb-[118px] lg:pb-[98px] sm:pb-[68px] xs:pb-[48px] text-center bg-[url('https://img.freepik.com/free-photo/portrait-firefighter-standing-front-fire-engine_1157-46925.jpg?t=st=1744093311~exp=1744096911~hmac=da4b6370b539d463bc8f7ffa07619326bcdbcc7302340082a6421d0a23676c50&w=1380')] bg-no-repeat bg-cover bg-center relative z-[1] overflow-hidden before:absolute before:-z-[1] before:inset-0 before:bg-edblue/70 before:pointer-events-none">
            ...
            <section class="py-[120px] xl:py-[80px] md:py-[60px]">
                <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
                    <div class="flex sm:flex-col items-start justify-between gap-[15px]">
                        <h2 class="ed-section-title">About Sealtight LPG Solutions</h2>
                        ...
                        <div class="max-w-[50%] sm:max-w-full mb-[60px]">
                            ...
                            <a href="#"
                                class="font-medium text-edpurple inline-flex items-center gap-[10px] border-b border-edpurple">Overview
                                <span class="icon"><img src="/assets/img/icon/arrow-up-right.svg" alt="icon"></span></a>
                        </div>
                    </div>

                    <div class="flex items-center">
                        <div class="md:w-[10%] xxs:w-[5%]">
                            <img src="/assets/img/about-inner-img.jpg" alt="About image"
                        ...
                        <div class="md:w-[90%] xxs:w-[95%]">
                            <div
                                ...
                                <h6
                                    ...
                                    About Edutics</h6>
                                <h4
                                    class="font-semibold text-[30px] md:text-[26px] xs:text-[22px] leading-[1.2] mb-[26px]">
                                    WE SUPPORT YOUR AMBITION</h4>
                                <ul
                                ...
                                <div class="flex flex-wrap items-center gap-x-[24px] gap-y-[20px]">
                                    <div class="flex gap-x-[8px]">
                                        <div class="rounded-full overflow-hidden w-[58px] aspect-square shrink-0">
                                            <img src="/assets/img/user.png" alt="Principal"
                                                class="w-[58px] aspect-square">
                                        </div>
                                        <div>
                                            <h5 class="font-semibold text-[18px] text-black mb-[4px]">Ronald Richards
                                            </h5>
                                            <h6 class="text-edgray">Principal <span class="text-edpurple">Edutics</span>
                                            </h6>
                                        </div>
                                    </div>
                                    <a href="contact.html" class="ed-btn gap-[10px]">message principal <span
                                            class="icon"><i class="fa-solid fa-arrow-right-long"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="bg-[#FAF9F6] relative z-[1] overflow-hidden">
                <div
                    ...
                    <div class="py-[120px] xl:py-[80px] md:py-[60px]">
                        ...
                        <p class="text-edgray mb-[11px]">There are many variations of passages of Lorem Ipsum available,
                            but the majority have suffered alteration in some form, by injected humor.</p>
                        <h6
                            class="font-semibold text-[18px] text-[#002147] mb-[23px] relative pl-[30px] before:absolute before:bg-edyellow before:w-[20px] before:h-[2px] before:left-0 before:top-[50%] before:-translate-y-[50%]">
                            We provide the best success opportunities</h6>
                        <ul
                    ...
                    <div class="relative shrink-0 xxxl:max-w-[55%] lg:max-w-full">
                        ...
                        <div
                            ...
                            <h4 class="font-semibold text-[30px] xs:text-[26px] xxs:text-[22px] mb-[12px]">Find A career
                                that suits you</h4>

                            <form action="#">
                                <label for="career-interest"
                                    class="text-[15px] font-medium inline-block mb-[10px]">Choose a Career
                                    Interest</label>
                                <div class="flex xxs:flex-col gap-[15px]">
                                    ...
                                    <button type="submit"
                                        class="ed-btn !h-[56px] shrink-0 !rounded-[4px]">Continue</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <!-- vector -->
                <img src="/assets/img/employability-vector.svg" alt="vector"
            ...
            <section class="py-[120px] xl:py-[80px] md:py-[60px] ">
                <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
                    <!-- heading -->
                    <div
                        class="flex flex-wrap items-center justify-between gap-x-[30px] gap-y-[15px] mb-[40px] xxs:mb-[30px]">
                        <div class="left">
                    ...
                    <div class="ed-program-slider swiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div>
                                    <span
                                        class="inline-flex items-center gap-[8px] px-[12px] py-[6px] border border-[#D4DCFF] rounded-[8px] text-[14px] font-medium text-edpurple mb-[11px]">
                                        <span class="icon"><svg width="20" height="16" viewBox="0 0 20 16" fill="none"
                                    ...
                                    <h5 class="font-bold text-[22px] text-black mb-[7px]"><a href="event-details.html"
                                            class="hover:text-edpurple">Attentive was born in 2015 help</a></h5>

                                    <p class="text-edgray mb-[15px]">There are many variations of passages of Lorem
                                        Ipsum available, but the majority have.</p>

                                    <a href="event-details.html"
                                        class="inline-flex items-center gap-[10px] underline text-edpurple font-medium hover:text-edyellow">Read
                                        More <span class="icon"><i class="fa-solid fa-arrow-right-long"></i></span></a>
                                </div>
                            </div>
                            <!-- single program -->
                            <div class="swiper-slide">
                                ...
                                <div>
                                    ...
                                    <h5 class="font-bold text-[22px] text-black mb-[7px]"><a href="event-details.html"
                                            class="hover:text-edpurple">Biotechnology</a></h5>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div>
                                    ...
                                    <h5 class="font-bold text-[22px] text-black mb-[7px]"><a href="event-details.html"
                                            class="hover:text-edpurple">Public Administration</a></h5>
            ...
            <section class="bg-edpurple relative z-[1] overflow-hidden">
                <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
                    <div class="flex md:flex-col items-center gap-[60px] lg:gap-[40px] md:gap-y-[20px]">
                        <div class="grow md:pt-[60px]">
                            <h6 class="ed-section-sub-title ed-section-sub-title--white">ARE YOU READY FOR THIS OFFER
                            </h6>
                        ...
                        <div class="shrink-0 relative z-[1] pr-[40px] lg:pr-0">
                            ...
                            <img src="/assets/img/cta-img-vector.svg" alt="vector"
                ...
                <!-- vector -->
                <div>
                    <img src="/assets/img/cta-vector-1.png" alt="vector"
                        class="absolute -z-[1] bottom-0 left-0 pointer-events-none">
                    <img src="/assets/img/cta-vector-2.png" alt="vector"
                ...
                <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
                    <div class="flex md:flex-col items-start gap-y-[40px]">
                        ...
                        <div class="max-w-[50%] md:max-w-full">
                            <!-- heading -->
                            <div
                                class="pb-[40px] sm:pb-[20px] bg-[url('../assets/img/testimonial-heading-vector.svg')] bg-no-repeat bg-left-bottom bg-[length:1000px] mb-[40px]  md:bg-none md:mb-0">
                            ...
                            <div class="flex xxs:flex-col gap-[15px] items-center relative pr-[35px]">
                                <div class="ed-testimonial-slider swiper max-w-full">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div>
                                                ...
                                                <p class="text-edgray mb-[24px]">Nullam dignissim ante scelerisque the
                                                    is euismod fermentum odio sem semper the is erat a feugiat leo urna
                                                    eget eros. Duis Aenean a imperdiet risus. Aliquam pellentesque.</p>
                                                <div>
                                    ...
                                    <div
                                        class="flex gap-[10px] items-center absolute z-[1] bottom-[10px] right-0 ed-testimonial-slider-controls">
                                        <button class="prev hover:text-edpurple"><i
                                                class="fa-solid fa-arrow-left-long"></i></button>
                                        <div
                                            class="ed-testimonial-slider-pagination font-semibold text-[14px] text-edblue">
                                        </div>
                        ...
                        <div>
                            <!-- heading -->
                            <div
                                class="pb-[40px] sm:pb-[20px] flex justify-end md:justify-start bg-[url('../assets/img/testimonial-heading-vector.svg')] bg-no-repeat bg-right-bottom bg-[length:1000px] mb-[40px] md:bg-none md:mb-0">
                                <div>
                                ...
                                <div
                                    ...
                                    <div>
                                        <h5 class="font-semibold text-[20px] mb-[7px]"><a href="#"
                                                class="hover:text-edpurple">SAT Implementation Workshops November
                                                2026</a></h5>
