            ...
            <section
                ...
                <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
                    ...
                    <ul class="flex items-center justify-center gap-[10px] text-white">
                        <li>
                            <NuxtLink href="index.html" class="text-edyellow">Home</NuxtLink>
                        </li>
                ...
                <div class="container mx-auto max-w-[1200px] px-[12px] xl:max-w-full">
                    <div class="grid grid-cols-2 md:grid-cols-1 gap-[60px] xl:gap-[40px] items-center">
                        ...
                        <div class="rounded-[16px] overflow-hidden">
                            <div class="bg-edpurple p-[40px] sm:p-[30px] xxs:p-[20px] space-y-[24px] text-[16px]">
                                ...
                                <div
                                    ...
                                    <div class="txt">
                                        <span class="font-normal">Call us 24/7</span>
                                        <h4 class="font-medium text-[24px] xxs:text-[22px]">
                                            <NuxtLink href="tel:+208-555-0112">+254 704 123 574</NuxtLink>
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="txt">
                                        <span class="font-normal">Write to us</span>
                                        <h4 class="font-medium text-[24px] xxs:text-[22px]">
                                            <NuxtLink href="mailto:eventek@gmail.com">Info@sealtightlpg.com</NuxtLink>
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="txt">
                                        <span class="font-normal">Our Location</span>
                                        <h4 class="font-medium text-[24px] xxs:text-[22px]">
                                            Delpack Business Complex <br> Donholm | Nairobi | Kenya
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- video cover -->
                            <!-- <div class="relative">
                                <img src="/assets/img/contact-video-cover.jpg" alt="video cover"
                                    class="w-full brightness-[80%]">
                                <NuxtLink href="https://youtu.be/5ppDzM8m9lI?si=zml3HbV176DBsZlg" data-fslightbox
                                    class="video-btn-shadow w-[58px] aspect-square rounded-full bg-white text-[18px] text-edpurple flex items-center justify-center absolute top-[50%] left-[50%] -translate-y-[50%] -translate-x-[50%]">
                        ...
                        <div>
                            ...
                            <!-- <p class="text-edgray font-normal text-[16px] mb-[38px]">Nullam varius, erat quis iaculis
                                dictum, eros urna varius eros, ut blandit felis odio in turpis. Quisque rhoncus, eros in
                                auctor ultrices,</p> -->
                            ...
                            <form action="#"
                                ...
                                <div class="col-span-2 xxs:col-span-1">
                                    <label for="ed-contact-message"
                                        class="font-lato font-semibold text-edblue block mb-[12px]">Your
                                        Message*</label>
